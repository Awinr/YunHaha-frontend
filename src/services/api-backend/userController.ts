...
/** genApiKeys POST /user/genApiKeys */
export async function genApiKeysUsingPOST(
  body: API.GenApiKeysRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/user/genApiKeys', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function userLoginByWxOpenUsingGET(
  ...
  return request<API.BaseResponseUserVO_>('/user/login/wx_open', {
    method: 'GET',
    params: {
      ...params,
    },
